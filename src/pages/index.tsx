  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing - Empowering individual customers to conveniently book nearby cars, while providing operations staff with centralized dashboards for efficient management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing - Empowering individual customers to conveniently book nearby cars, while providing operations staff with centralized dashboards for efficient management.`}
            </Text>
            <Box
